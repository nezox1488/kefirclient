...
/**
 * Снимок и восстановление критичных GL-состояний, чтобы не ломать пайплайн игры.
 */
public final class GlState {

    public static final class Snapshot {
        int framebuffer; // legacy combined binding
        int drawFramebuffer;
        int readFramebuffer;
    ...
    public static void pop(Snapshot s) {
        ...
        // Then restore read/draw buffers for the restored FBOs
